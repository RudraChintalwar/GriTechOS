      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-bold font-display mb-6">
            <span className="text-foreground">{t("facilitator.heading1")}</span>
            <span className="text-gradient">{t("facilitator.heading2")}</span>
          </h2>
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="glass-card p-4 rounded-xl">
                  <p className="text-sm text-muted-foreground mb-2">
                    {t("facilitator.simpleLang")}
                  </p>
                  <p className="text-foreground">
                    "आपको प्रति वर्ष ₹6,000 मिलेंगे"
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="glass-card p-4 rounded-xl">
                  <p className="text-sm text-muted-foreground mb-2">
                    {t("facilitator.batchProcessing")}
                  </p>
                  <div className="flex items-center gap-2">
                    <span className="text-foreground font-medium">
                      12 {t("facilitator.farmers")}
                    </span>
                    <ArrowRight className="w-4 h-4 text-muted-foreground" />
                    <span className="text-foreground font-medium">
                      47 {t("facilitator.schemes")}
                    </span>
                  </div>
                </div>
